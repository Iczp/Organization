...
namespace IczpNet.Organization.Migrations
{
    ...
    [Migration("20221123025635_EmployeeFilter_AlertProp_FilterParameter")]
    partial class EmployeeFilter_AlertProp_FilterParameter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IczpNet.Organization.EmployeeFilters.EmployeeFilter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FilterParameter")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.ToTable("Organization_EmployeeFilter", (string)null);
                });
            ...
            modelBuilder.Entity("IczpNet.Organization.EmployeeTypes.EmployeeType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Organization_EmployeeType", (string)null);
                });
            ...
            modelBuilder.Entity("IczpNet.Organization.PositionTypes.PositionType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Organization_PositionType", (string)null);
                });
            ...
            modelBuilder.Entity("IczpNet.Organization.DepartmentTypes.DepartmentType", b =>
                {
                    b.HasOne("IczpNet.Organization.DepartmentTypes.DepartmentType", "Parent")
                        .WithMany("Childs")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("IczpNet.Organization.Employees.Employee", b =>
                {
                    ...
                    b.HasOne("IczpNet.Organization.EmployeeTypes.EmployeeType", "EmployeeType")
                        .WithMany("EmployeeList")
            ...
            modelBuilder.Entity("IczpNet.Organization.Positions.Position", b =>
                {
                    ...
                    b.HasOne("IczpNet.Organization.PositionTypes.PositionType", "PositionType")
                        .WithMany("PositionList")
